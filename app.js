...
const F = {
  ...
  tage:'马远踏歌图轴.png',
  xishan:'夏圭 溪山清远图.jpg',
  yuzhuang:'倪瓒 渔庄秋霁图轴.jpg',
  guoguo:'唐 张萱 虢国夫人游春图.jpg',
  huishan:'周昉挥扇仕女图卷.png',
  xiaoxiang:'董源潇湘图卷.png',
  wangshu:'唐寅王蜀宫妓图轴.png',
  hangong:'Spring Morning in the Han Palace (汉宫春晓图).jpg',
  wenzm:'文徵明山水扇.png',
  dongqc:'董其昌山水轴.png',
  huayan:'华喦花鸟册10.png',
  renbn:'任伯年 - 花鸟扇面 1.jpg',
  litang:'Li Tang - Wind in Pines Among a Myriad Valleys.jpg',
  mozhu:'柯九思 墨竹图卷.jpg',
  chenhs:'陈洪绶人物轴.png',
  furong:'赵佶芙蓉锦鸡图轴.png',
  shuangxi:'北宋．崔白〈雙喜圖〉.jpg',
  houmao:'猴貓圖.jpg',
  linchun:'林椿果熟来禽图页.png',
  mamlin:'马麟层叠冰绡图轴.png',
  // 世界名画扩充
  milkmaid:'Johannes Vermeer - Het melkmeisje - Google Art Project.jpg',
  venus:'Sandro Botticelli 046.jpg',
  primavera:'Botticelli-primavera.jpg',
  supper:'Leonardo da Vinci (1452-1519) - The Last Supper (1495-1498).jpg',
  goya:'El Tres de Mayo, by Francisco de Goya, from Prado thin black margin.jpg',
  marat:'Death of Marat by David.jpg',
  gleaners:'Jean-François Millet - Gleaners - Google Art Project 2.jpg',
  manet:'Edouard Manet - Luncheon on the Grass - Google Art Project.jpg',
  parasol:'Claude Monet - Woman with a Parasol - Madame Monet and Her Son - Google Art Project.jpg',
  boating:'Pierre-Auguste Renoir - Luncheon of the Boating Party - Google Art Project.jpg',
  cezanne:'La Montagne Sainte-Victoire vue de la carrière Bibémus, par Paul Cézanne.jpg',
  gauguin:'Paul Gauguin - Deux Tahitiennes.jpg',
  matthew:'Calling-of-st-matthew.jpg',
  turner:'The Fighting Temeraire, JMW Turner, National Gallery.jpg',
  adele:'Gustav Klimt, 1907, Adele Bloch-Bauer I, Neue Galerie New York.jpg',
  tsunami:'Tsunami by hokusai 19th century.jpg',
  plumgarden:'De pruimenboomgaard te Kameido-Rijksmuseum RP-P-1956-743.jpeg',
  meninas:'Las Meninas, by Diego Velázquez, from Prado in Google Earth.jpg',
  odalisque:'Tête de la grande odalisque couchée par Jean-Auguste-Dominique Ingres.jpg',
  sharaku:'Sharaku (1795) Bandō Mitsugorō II as Soga Gorō Tokimune.jpg',
  nihonbashi:"Tōkaidô gojūsan tsugi saiken zu'e, Nihonbashi by Hiroshige.jpg",
  napoleon:'Napoleon at the Great St. Bernard - Jacques-Louis David - Google Cultural Institute.jpg',
  urbino:'Tiziano - Venere di Urbino - Google Art Project.jpg',
  wanderer:'Caspar David Friedrich - Wanderer above the sea of fog.jpg',
  dance:'La Danse I, par Henri Matisse.jpg',
  courbet:'Gustave Courbet 018.jpg',
};
const LIB = {
  // 经典范作（按题材浏览）
  guozhan: [
    { name:'簪花仕女图', artist:'周昉 · 工笔人物', art:'shinv', file:F.zanhua, cat:'人物', prompt:'工笔仕女，唐代簪花仕女，丰腴华贵，线条圆润，精细描绘' },
    { name:'女史箴图', artist:'顾恺之 · 东晋', art:'shinv', file:F.nvshi, cat:'人物', prompt:'工笔人物，女史箴图，高古游丝描，端庄典雅' },
    { name:'虢国夫人游春图', artist:'张萱 · 唐', art:'shinv', file:F.guoguo, cat:'人物', prompt:'工笔人物，仕女骑马，雍容华贵' },
    { name:'挥扇仕女图', artist:'周昉 · 唐', art:'shinv', file:F.huishan, cat:'人物', prompt:'工笔仕女，纨扇轻摇，宫廷闲情' },
    { name:'王蜀宫妓图', artist:'唐寅 · 明', art:'shinv', file:F.wangshu, cat:'人物', prompt:'工笔仕女，宫妓盛装，细腻设色' },
    { name:'汉宫春晓图', artist:'仇英 · 明', art:'shinv', file:F.hangong, cat:'人物', prompt:'工笔长卷，汉宫春晓，金碧辉煌' },
    { name:'人物图', artist:'陈洪绶 · 明', art:'shinv', file:F.chenhs, cat:'人物', prompt:'陈洪绶人物，高古奇骇，古雅韵致' },
    { name:'芙蓉锦鸡图', artist:'宋徽宗 · 北宋', art:'gongbi', file:F.furong, cat:'花鸟', prompt:'工笔花鸟，芙蓉锦鸡，富丽精工' },
    { name:'双喜图', artist:'崔白 · 北宋', art:'gongbi', file:F.shuangxi, cat:'花鸟', prompt:'工笔花鸟，寒林双鹊，野趣生动' },
    { name:'果熟来禽图', artist:'林椿 · 南宋', art:'gongbi', file:F.linchun, cat:'花鸟', prompt:'工笔花鸟，果熟来禽，精致小品' },
    { name:'层叠冰绡图', artist:'马麟 · 南宋', art:'gongbi', file:F.mamlin, cat:'花鸟', prompt:'工笔花卉，白梅冰绡，清雅高洁' },
    { name:'猴猫图', artist:'易元吉 · 北宋', art:'gongbi', file:F.houmao, cat:'花鸟', prompt:'工笔走兽，猿猴猫趣，生动传神' },
    { name:'墨竹图', artist:'柯九思 · 元', art:'zhu', file:F.mozhu, cat:'花鸟', prompt:'文人墨竹，挺拔清雅，书写笔意' },
    { name:'花鸟册', artist:'华喦 · 清', art:'lotus', file:F.huayan, cat:'花鸟', prompt:'小写意花鸟，清新灵动，扬州画派' },
    { name:'花鸟扇面', artist:'任伯年 · 近代', art:'lotus', file:F.renbn, cat:'花鸟', prompt:'海派花鸟，雅俗共赏，笔墨灵动' },
    { name:'游春图', artist:'展子虔 · 隋', art:'shanshui', file:F.youchun, cat:'山水', prompt:'青绿山水，游春图景，开山水先河' },
    { name:'万壑松风图', artist:'李唐 · 南宋', art:'shanshui', file:F.litang, cat:'山水', prompt:'李唐山水，万壑松风，斧劈皴，气势磅礴' },
    { name:'踏歌图', artist:'马远 · 南宋', art:'shanshui', file:F.tage, cat:'山水', prompt:'马远山水，边角构图，踏歌田园' },
    { name:'溪山清远图', artist:'夏圭 · 南宋', art:'shanshui', file:F.xishan, cat:'山水', prompt:'夏圭山水，溪山清远，水墨苍润' },
    { name:'潇湘图', artist:'董源 · 五代', art:'shanshui', file:F.xiaoxiang, cat:'山水', prompt:'董源山水，江南平远，烟雨苍茫' },
    { name:'渔庄秋霁图', artist:'倪瓒 · 元', art:'shanshui', file:F.yuzhuang, cat:'山水', prompt:'倪瓒山水，渔庄秋霁，逸笔疏简' },
    { name:'山水扇面', artist:'文徵明 · 明', art:'shanshui', file:F.wenzm, cat:'山水', prompt:'文徵明山水，吴门画派，文雅秀润' },
    { name:'山水轴', artist:'董其昌 · 明', art:'shanshui', file:F.dongqc, cat:'山水', prompt:'董其昌山水，南宗文人，笔墨秀逸' },
  ...
  masters: [
    ...
    { name:'女史箴图', artist:'顾恺之 · 东晋', art:'shinv', file:F.nvshi, cat:'古代', prompt:'顾恺之女史箴图，端庄典雅' },
    { name:'游春图', artist:'展子虔 · 隋', art:'shanshui', file:F.youchun, cat:'古代', prompt:'展子虔游春图，青绿山水' },
    { name:'虢国夫人游春图', artist:'张萱 · 唐', art:'shinv', file:F.guoguo, cat:'古代', prompt:'张萱虢国夫人游春图，雍容华贵' },
    { name:'挥扇仕女图', artist:'周昉 · 唐', art:'shinv', file:F.huishan, cat:'古代', prompt:'周昉挥扇仕女图，宫廷闲情' },
    { name:'五马图', artist:'李公麟 · 北宋', art:'gongbi', file:F.wuma, cat:'古代', prompt:'李公麟五马图，白描鞍马，线描精绝' },
    { name:'潇湘图', artist:'董源 · 五代', art:'shanshui', file:F.xiaoxiang, cat:'古代', prompt:'董源潇湘图，江南平远，烟雨苍茫' },
    { name:'万壑松风图', artist:'李唐 · 南宋', art:'shanshui', file:F.litang, cat:'古代', prompt:'李唐万壑松风，斧劈皴，气势磅礴' },
    { name:'踏歌图', artist:'马远 · 南宋', art:'shanshui', file:F.tage, cat:'古代', prompt:'马远踏歌图，边角构图，意境清旷' },
    { name:'溪山清远图', artist:'夏圭 · 南宋', art:'shanshui', file:F.xishan, cat:'古代', prompt:'夏圭溪山清远，水墨苍润' },
    { name:'双喜图', artist:'崔白 · 北宋', art:'gongbi', file:F.shuangxi, cat:'古代', prompt:'崔白双喜图，寒林双鹊，野趣生动' },
    { name:'芙蓉锦鸡图', artist:'宋徽宗 · 北宋', art:'gongbi', file:F.furong, cat:'古代', prompt:'宋徽宗芙蓉锦鸡，富丽精工' },
    { name:'果熟来禽图', artist:'林椿 · 南宋', art:'gongbi', file:F.linchun, cat:'古代', prompt:'林椿果熟来禽，精致小品' },
    { name:'层叠冰绡图', artist:'马麟 · 南宋', art:'gongbi', file:F.mamlin, cat:'古代', prompt:'马麟层叠冰绡，白梅清雅' },
    { name:'猴猫图', artist:'易元吉 · 北宋', art:'gongbi', file:F.houmao, cat:'古代', prompt:'易元吉猴猫图，生动传神' },
    { name:'渔庄秋霁图', artist:'倪瓒 · 元', art:'shanshui', file:F.yuzhuang, cat:'古代', prompt:'倪瓒渔庄秋霁，逸笔疏简' },
    { name:'墨竹图', artist:'柯九思 · 元', art:'zhu', file:F.mozhu, cat:'古代', prompt:'柯九思墨竹，挺拔清雅' },
    { name:'王蜀宫妓图', artist:'唐寅 · 明', art:'shinv', file:F.wangshu, cat:'明清', prompt:'唐寅王蜀宫妓，细腻设色' },
    { name:'汉宫春晓图', artist:'仇英 · 明', art:'shinv', file:F.hangong, cat:'明清', prompt:'仇英汉宫春晓，金碧辉煌' },
    { name:'山水扇面', artist:'文徵明 · 明', art:'shanshui', file:F.wenzm, cat:'明清', prompt:'文徵明山水，文雅秀润' },
    { name:'山水轴', artist:'董其昌 · 明', art:'shanshui', file:F.dongqc, cat:'明清', prompt:'董其昌山水，南宗文人' },
    { name:'人物图', artist:'陈洪绶 · 明', art:'shinv', file:F.chenhs, cat:'明清', prompt:'陈洪绶人物，高古奇骇' },
    { name:'花鸟册', artist:'华喦 · 清', art:'lotus', file:F.huayan, cat:'明清', prompt:'华喦小写意花鸟，扬州画派' },
    { name:'花鸟扇面', artist:'任伯年 · 近代', art:'lotus', file:F.renbn, cat:'近现代', prompt:'任伯年海派花鸟，笔墨灵动' },
  ...
  world: [
    ...
    { name:'最后的晚餐', artist:'达·芬奇 · 文艺复兴', art:'mona', file:F.supper, cat:'文艺复兴', prompt:'达芬奇最后的晚餐，宗教壁画，透视构图' },
    { name:'创造亚当', artist:'米开朗基罗 · 文艺复兴', art:'mona', file:F.adam, cat:'文艺复兴', prompt:'米开朗基罗创造亚当，壁画，人体雄健' },
    { name:'维纳斯的诞生', artist:'波提切利 · 文艺复兴', art:'pearl', file:F.venus, cat:'文艺复兴', prompt:'波提切利维纳斯诞生，优雅线条' },
    { name:'春', artist:'波提切利 · 文艺复兴', art:'pearl', file:F.primavera, cat:'文艺复兴', prompt:'波提切利春，群像神话，繁花似锦' },
    { name:'乌尔比诺的维纳斯', artist:'提香 · 文艺复兴', art:'pearl', file:F.urbino, cat:'文艺复兴', prompt:'提香乌尔比诺维纳斯，威尼斯画派' },
    { name:'读信的少女', artist:'维米尔 · 荷兰', art:'pearl', file:F.readletter, cat:'古典油画', prompt:'维米尔读信少女，窗边柔光' },
    { name:'倒牛奶的女仆', artist:'维米尔 · 荷兰', art:'pearl', file:F.milkmaid, cat:'古典油画', prompt:'维米尔倒奶女仆，日常静谧' },
    { name:'夜巡', artist:'伦勃朗 · 荷兰', art:'pearl', file:F.nightwatch, cat:'古典油画', prompt:'伦勃朗夜巡，明暗对比，戏剧光影' },
    { name:'宫娥', artist:'委拉斯开兹 · 西班牙', art:'pearl', file:F.meninas, cat:'古典油画', prompt:'委拉斯开兹宫娥，空间错觉' },
    { name:'圣马太蒙召', artist:'卡拉瓦乔 · 巴洛克', art:'pearl', file:F.matthew, cat:'古典油画', prompt:'卡拉瓦乔圣马太蒙召，强烈明暗' },
    { name:'马拉之死', artist:'大卫 · 新古典', art:'pearl', file:F.marat, cat:'古典油画', prompt:'大卫马拉之死，新古典主义' },
    { name:'拿破仑越过阿尔卑斯山', artist:'大卫 · 新古典', art:'mona', file:F.napoleon, cat:'古典油画', prompt:'大卫拿破仑越阿尔卑斯，英雄气概' },
    { name:'大宫女', artist:'安格尔 · 新古典', art:'pearl', file:F.odalisque, cat:'古典油画', prompt:'安格尔大宫女，曲线优雅' },
    { name:'1808年5月3日', artist:'戈雅 · 浪漫', art:'pearl', file:F.goya, cat:'古典油画', prompt:'戈雅五月三日，悲剧张力' },
    { name:'自由引导人民', artist:'德拉克洛瓦 · 浪漫', art:'mona', file:F.liberty, cat:'古典油画', prompt:'德拉克洛瓦自由引导人民，激昂场面' },
    { name:'雾海上的旅人', artist:'弗里德里希 · 浪漫', art:'shanshui', file:F.wanderer, cat:'古典油画', prompt:'弗里德里希雾海旅人，崇高苍茫' },
    { name:'战舰无畏号', artist:'透纳 · 浪漫', art:'monet', file:F.turner, cat:'古典油画', prompt:'透纳战舰无畏号，光色辉煌' },
    { name:'碎石工', artist:'库尔贝 · 现实', art:'pearl', file:F.courbet, cat:'古典油画', prompt:'库尔贝碎石工，现实主义' },
    { name:'拾穗者', artist:'米勒 · 现实', art:'pearl', file:F.gleaners, cat:'古典油画', prompt:'米勒拾穗者，田园劳动' },
    { name:'草地上的午餐', artist:'马奈 · 印象', art:'pearl', file:F.manet, cat:'印象派', prompt:'马奈草地午餐，光色革新' },
    { name:'撑阳伞的女人', artist:'莫奈 · 印象', art:'monet', file:F.parasol, cat:'印象派', prompt:'莫奈撑阳伞女人，外光画法' },
    { name:'船上的午宴', artist:'雷诺阿 · 印象', art:'monet', file:F.boating, cat:'印象派', prompt:'雷诺阿船上午宴，明快光色' },
    { name:'圣维克多山', artist:'塞尚 · 后印象', art:'shanshui', file:F.cezanne, cat:'后印象', prompt:'塞尚圣维克多山，几何结构' },
    { name:'两个塔希提妇女', artist:'高更 · 后印象', art:'pearl', file:F.gauguin, cat:'后印象', prompt:'高更塔希提妇女，平涂浓色' },
    { name:'呐喊', artist:'蒙克 · 表现', art:'starry', file:F.scream, cat:'现代', prompt:'蒙克呐喊，扭曲线条，血色天空' },
    { name:'吻', artist:'克里姆特 · 象征', art:'mona', file:F.kiss, cat:'现代', prompt:'克里姆特吻，金箔装饰' },
    { name:'阿黛尔肖像', artist:'克里姆特 · 象征', art:'mona', file:F.adele, cat:'现代', prompt:'克里姆特阿黛尔，金色装饰' },
    { name:'舞蹈', artist:'马蒂斯 · 野兽', art:'mona', file:F.dance, cat:'现代', prompt:'马蒂斯舞蹈，纯色平涂，律动' },
    { name:'美国哥特', artist:'格兰特·伍德 · 现代', art:'pearl', file:F.gothic, cat:'现代', prompt:'美国哥特，写实人物，质朴乡土' },
    { name:'巨浪', artist:'葛饰北斋 · 浮世绘', art:'hokusai', file:F.tsunami, cat:'浮世绘', prompt:'葛饰北斋巨浪，波涛汹涌' },
    { name:'日本桥', artist:'歌川广重 · 浮世绘', art:'hokusai', file:F.nihonbashi, cat:'浮世绘', prompt:'歌川广重日本桥，江户风情' },
    { name:'梅园', artist:'歌川广重 · 浮世绘', art:'hokusai', file:F.plumgarden, cat:'浮世绘', prompt:'歌川广重梅园，梅枝构图新颖' },
    { name:'役者绘', artist:'东洲斋写乐 · 浮世绘', art:'hokusai', file:F.sharaku, cat:'浮世绘', prompt:'写乐役者绘，歌舞伎肖像，夸张传神' },
...
function renderVip(){
  ...
  document.getElementById('vipStatus').innerHTML = member
    ...
    : `<div class="vip-off"><div class="vo-title">🔒 开通会员，解锁全部国画资料</div>
        ...
        <div class="redeem-tip">购买会员请 <b onclick="showRecharge()">点此充值</b>，或联系客服微信 <b>18专属客服</b> 获取兑换码</div></div>`;
  renderVipList(null);
}
